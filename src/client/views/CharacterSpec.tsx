                ...
                <div className="card col-12 col-md-10 mt-5">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-footer">
                            <p>Appears In: </p>
                            {tags.map(tag => (
                                <Link to={'/articles/' + tag.article_id} style={{textDecoration: 'none'}} className='btn btn-outline-primary me-2 col-3' key={tag.article_id}>{tag.title}</Link>
                            ))}
                        </div>
                        <div className="row mt-5">
                            <Link to={'/characters/edit/'+ character?.id} style={{textDecoration: 'none'}} className='btn btn-outline-warning col-2 me-2'>Edit</Link>
                            <button className='btn btn-outline-danger col-2' onClick={handleDelete}>Delete</button>
                        </div>
                    </div>
                </div>
            </div>
